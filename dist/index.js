...
var TrackingContext = require$$0.createContext(null);
function TrackerProvider(_a) {
    ...
    var _e = require$$0.useState(false), isInitialized = _e[0], setIsInitialized = _e[1];
    var _f = require$$0.useState(null), sessionId = _f[0], setSessionId = _f[1];
    var _g = require$$0.useState(null), userId = _g[0], setUserId = _g[1];
    var activityTrackerRef = require$$0.useRef(null);
    var startTimeRef = require$$0.useRef(Date.now());
    var config = {
        siteId: siteId,
        domain: domain,
        serverUrl: serverUrl,
    ...
    var sendTrackingData = require$$0.useCallback(function (eventType_1) {
        var args_1 = [];
    ...
    // Track function
    var track = require$$0.useCallback(function (eventType, data) {
...
function useTrack() {
    var context = require$$0.useContext(TrackingContext);
    if (!context) {
...
function useTracking() {
    ...
    var track = require$$0.useCallback(function () { return ({
        // Custom events
